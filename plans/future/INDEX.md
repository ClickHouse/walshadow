...
* [failover.md](failover.md) — lossless source continuation across descendant PostgreSQL timelines: planned switchover protocol (pause, prove frontier, promote, resume), historic WAL drain, fork-segment verification, shadow handoff, lineage-aware restart, ancestor-timeline base backups
