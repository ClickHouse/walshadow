//! Phase 12 — file-streaming bootstrap end-to-end via the direct
//! replication-protocol source.
//!
//! Sibling of `phase12_object_store_e2e.rs` for the
...
/// Reserved port slot — 56145 sits between `phase12_object_store_e2e`
...
async fn direct_source_self_hosted_via_replication_protocol() {
    ...
    let pgcfg = PgConfig {
        ...
        application_name: "walshadow-phase12-direct".into(),
        sslmode: SslMode::Disable,
    };
    let opts = BaseBackupOpts {
        label: "phase12-direct".into(),
