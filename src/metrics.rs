...
pub fn render(snap: &MetricsSnapshot) -> String {
    ...
    let pairs: &[(&str, &str, &str, u64)] = &[
        ...
        (
            "walshadow_oracle_resolved_total",
            "PgPending columns resolved via the walshadow_oracle extension.",
            "counter",
            snap.oracle_resolved_total,
        ),
        (
            "walshadow_oracle_fallback_raw_total",
            "PgPending columns shipped as raw bytes (extension absent).",
            "counter",
            snap.oracle_fallback_raw_total,
        ),
        (
            "walshadow_oracle_validate_sampled_total",
            "Rows the differential-decode sampler probed.",
            "counter",
            snap.oracle_validate_sampled_total,
        ),
        (
            "walshadow_oracle_validate_mismatches_total",
        ...
        (
            ...
            "Oracle SQL errors swallowed by the fallback path.",
            "counter",
