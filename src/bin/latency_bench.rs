...
mod tests {
    ...
    fn args_parse_single_row_defaults() {
        ...
        assert_eq!(args.bench, Bench::SingleRow);
        assert_eq!(args.pg_host, "127.0.0.1");
        assert_eq!(args.pg_port, 5432);
        assert_eq!(args.pg_user, "postgres");
        assert_eq!(args.pg_dbname, "postgres");
        assert_eq!(args.table, "demo.users");
        assert_eq!(args.ch_host, "127.0.0.1");
        assert_eq!(args.ch_http_port, 8123);
        assert_eq!(args.ch_table, "demo.users");
        assert_eq!(args.iterations, 100);
        assert_eq!(args.warmup, 10);
        assert_eq!(args.id_base, 1_000_000);
    }
    ...
    fn args_parse_sustained_overrides() {
        ...
        assert_eq!(args.bench, Bench::Sustained);
        assert_eq!(args.rate, 500);
        assert_eq!(args.duration_secs, 7);
        assert_eq!(args.probe_every, 3);
        assert_eq!(args.concurrency, 4);
        assert_eq!(args.pg_password.as_deref(), Some("secret"));
    }
